...
/// {@template slideisland_share_dialog}
/// Displays a SlideIsland share dialog with a score of the completed puzzle
/// and an option to share the score using Twitter or Facebook.
/// {@endtemplate}
class SlideIslandShareDialog extends StatefulWidget {
  /// {@macro slideisland_share_dialog}
  const SlideIslandShareDialog({
    Key? key,
  ...
  @override
  State<SlideIslandShareDialog> createState() => _SlideIslandShareDialogState();
}

class _SlideIslandShareDialogState extends State<SlideIslandShareDialog>
  ...
  Widget build(BuildContext context) {
    return AudioControlListener(
      key: const Key('slideisland_share_dialog_success_audio_player'),
      audioPlayer: _successAudioPlayer,
      child: AudioControlListener(
        key: const Key('slideisland_share_dialog_click_audio_player'),
        ...
        child: ResponsiveLayoutBuilder(
          ...
          child: (currentSize) {
            ...
            return Stack(
              key: const Key('slideisland_share_dialog'),
              children: [
                  ...
                  child: LayoutBuilder(
                    builder: (context, constraints) {
                      return SizedBox(
                        ...
                        child: Padding(
                          padding: padding,
                          child: SlideIslandShareDialogAnimatedBuilder(
                ...
                Positioned(
                  ...
                  child: IconButton(
                    key: const Key('slideisland_share_dialog_close_button'),
