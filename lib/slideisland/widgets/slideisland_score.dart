...
/// {@template slideisland_score}
/// Displays the score of the solved SlideIsland puzzle.
/// {@endtemplate}
class SlideIslandScore extends StatelessWidget {
  /// {@macro slideisland_score}
  const SlideIslandScore({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return ResponsiveLayoutBuilder(
      ...
      child: (currentSize) {
        ...
        return ClipRRect(
          key: const Key('slideisland_score'),
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(
                        key: const Key('slideisland_score_completed'),
                        ...
                        child: AnimatedDefaultTextStyle(
                          ...
                          child: Text(l10n.slideislandSuccessCompleted),
                        ),
                      ),
                      const ResponsiveGap(
                        small: 8,
                      ...
                      AnimatedDefaultTextStyle(
                        key: const Key('slideisland_score_well_done'),
                        style: wellDoneTextStyle.copyWith(
                          color: PuzzleColors.white,
                        ),
                        duration: PuzzleThemeAnimationDuration.textStyle,
                        child: Text(l10n.slideislandSuccessWellDone),
                      ),
                      const ResponsiveGap(
                        small: 24,
                        medium: 32,
                      ...
                      AnimatedDefaultTextStyle(
                        key: const Key('slideisland_score_score'),
                        style: PuzzleTextStyle.headline5.copyWith(
                          color: theme.defaultColor,
                        ),
                        duration: PuzzleThemeAnimationDuration.textStyle,
                        child: Text(l10n.slideislandSuccessScore),
                      ),
                      const ResponsiveGap(
                        small: 8,
                        medium: 9,
                      ...
                      AnimatedDefaultTextStyle(
                        key: const Key('slideisland_score_number_of_moves'),
                        style: numberOfMovesTextStyle.copyWith(
                          color: PuzzleColors.white,
                        ),
                        duration: PuzzleThemeAnimationDuration.textStyle,
                        child: Text(
                          l10n.slideislandSuccessNumberOfMoves(
