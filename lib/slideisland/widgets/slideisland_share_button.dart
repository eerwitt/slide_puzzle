...
/// {@template slideisland_twitter_button}
/// Displays a button that shares the Flutter Puzzle challenge
/// on Twitter when tapped.
/// {@endtemplate}
class SlideIslandTwitterButton extends StatelessWidget {
  /// {@macro slideisland_twitter_button}
  const SlideIslandTwitterButton({Key? key}) : super(key: key);

  String _twitterShareUrl(BuildContext context) {
    final shareText = context.l10n.slideislandSuccessShareText;
...
/// {@template slideisland_facebook_button}
/// Displays a button that shares the Flutter Puzzle challenge
/// on Facebook when tapped.
/// {@endtemplate}
class SlideIslandFacebookButton extends StatelessWidget {
  /// {@macro slideisland_facebook_button}
  const SlideIslandFacebookButton({Key? key}) : super(key: key);
...
/// {@template slideisland_share_button}
/// Displays a share button colored with [color] which
/// displays the [icon] and [title] as its content.
/// {@endtemplate}
@visibleForTesting
class SlideIslandShareButton extends StatefulWidget {
  /// {@macro slideisland_share_button}
  const SlideIslandShareButton({
    Key? key,
  ...
  @override
  State<SlideIslandShareButton> createState() => _SlideIslandShareButtonState();
}

class _SlideIslandShareButtonState extends State<SlideIslandShareButton> {
