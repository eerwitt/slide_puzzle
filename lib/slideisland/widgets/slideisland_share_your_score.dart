...
/// {@template slideisland_share_your_score}
/// Displays buttons to share a score of the completed puzzle.
/// {@endtemplate}
class SlideIslandShareYourScore extends StatelessWidget {
  /// {@macro slideisland_share_your_score}
  const SlideIslandShareYourScore({
    Key? key,
    required this.animation,
  }) : super(key: key);

  /// The entry animation of this widget.
  final SlideIslandShareDialogEnterAnimation animation;
  ...
  Widget build(BuildContext context) {
    ...
    return ResponsiveLayoutBuilder(
      ...
      child: (currentSize) {
        ...
        return Column(
          key: const Key('slideisland_share_your_score'),
            ...
            SlideTransition(
              ...
              child: Opacity(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      l10n.slideislandSuccessShareYourScoreTitle,
                      key: const Key('slideisland_share_your_score_title'),
                      textAlign: textAlign,
                    ...
                    SizedBox(
                      width: messageWidth,
                      child: Text(
                        l10n.slideislandSuccessShareYourScoreMessage,
                        key: const Key('slideisland_share_your_score_message'),
                        textAlign: textAlign,
            ...
            SlideTransition(
              ...
              child: Opacity(
                ...
                child: Row(
                  ...
                  children: const [
                    SlideIslandTwitterButton(),
                    Gap(16),
                    SlideIslandFacebookButton(),
                  ],
                ),
              ),
            ),
