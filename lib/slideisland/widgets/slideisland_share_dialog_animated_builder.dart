...
/// The animation builder of [SlideIslandShareDialog].
class SlideIslandShareDialogAnimatedBuilder extends StatelessWidget {
  const SlideIslandShareDialogAnimatedBuilder({
    Key? key,
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return builder(
          context,
          child,
          SlideIslandShareDialogEnterAnimation(
...
typedef MyTransitionBuilder = Widget Function(
  ...
  Widget? child,
  SlideIslandShareDialogEnterAnimation animation,
);

class SlideIslandShareDialogEnterAnimation {
  SlideIslandShareDialogEnterAnimation(this.controller)
